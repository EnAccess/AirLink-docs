...
Issues are created [here](https://github.com/EnAccess/AirLink-docs/issues/new/choose)

### How to Contribute to Issues

For any issue, there are fundamentally three ways an individual can contribute:

- **By opening the issue for discussion:** If you believe that you have found a new bug in this project, you should report it by creating a new issue in the [issue tracker](https://github.com/EnAccess/AirLink-docs/issues).
...
- When opening a new issue in the [issue tracker](https://github.com/EnAccess/AirLink-docs/issues/new/choose), users will be presented with a template that should be filled in.
